...
export const departmentsByUniversity: DepartmentsByUniversity = {
  '건양대학교 메디컬캠퍼스': [
    '간호학과', '물리치료학과', '방사선학과', '병원경영학과', '안경광학과', '응급구조학과', '의공학과', '의료IT공학과', '의료공간디자인학과', '의료신소재학과', '의약바이오학과', '인공지능학과', '임상병리학과', '작업치료학과', '제약생명공학과', '치위생학과', '의학과'
  ],
  '건양대학교 창의융합캠퍼스': [
    '기업소프트웨어학부', '스마트보안학과', '융합디자인학과', '임상약학과', '의약바이오학과', '글로벌의료뷰티학과', '재난안전소방학과', '반도체공학과', '심리상담치료학과', '유아교육과', '특수교육과', '사회복지학과', '디지털콘텐츠학과', '시각디자인학과', '스포츠의학과', '재활퍼스널트레이닝학과', '경영학부', '호텔관광학과', '금융세무학부', '국방경찰행정학부', '군사학과'
  ],
  '대전대학교': [
  ...
  // ]
  '고려대학교 세종캠퍼스': [
    '응용수리과학부 – 데이터계산과학[교직]', '반도체물리학부', '신소재화학과', '컴퓨터응용소프트웨어학과', '전자및정보공학과', '생명정보공학과', '식품생명공학과', '전자기계융합공학과', '환경시스템공학과', '미래모빌리티학과', '지능형반도체공학과', '인공지능사이버보안학과', '디지털헬스케어공학과', '약학과', '첨단융합신약학과', '글로벌학부 – 한국학[교직]', '글로벌학부 – 중국학[교직]', '글로벌학부 – 영미학[교직]', '융합경영학부 – 글로벌경영', '융합경영학부 – 디지털경영', '표준지식학과', '정부행정학부', '공공사회통일외교학부 – 공공사회학', '공공사회통일외교학부 – 통일외교안보', '경제통계학부 – 경제정책학', '빅데이터사이언스학부', '국제스포츠학부 – 스포츠과학', '국제스포츠학부 – 스포츠비즈니스', '문화유산융합학부', '문화창의학부 – 미디어문예창작', '문화창의학부 – 문화콘텐츠', '스마트도시학부'
  ],
  '홍익대학교 세종캠퍼스': [
    '세종캠퍼스자율전공(자연·예능)', '세종캠퍼스자율전공(인문·예능)', '과학기술대학자율전공', '전자전기융합공학과', '소프트웨어융합학과', '나노신소재학과', '건축공학부', '기계정보공학과', '조선해양공학과', '바이오화학공학과', '게임학부 게임소프트웨어전공(공학계)', '상경학부', '광고홍보학부', '디자인컨버전스학부', '영상·애니메이션학부', '게임학부 게임그래픽디자인전공(미술계)', '산업스포츠학과'
  ],
  '한국교원대학교': [
    '교육학과', '유아교육과', '초등교육과', '특수교육과', '국어교육과', '영어교육과', '독어교육과', '불어교육과', '중국어교육과', '윤리교육과', '일반사회교육과', '지리교육과', '역사교육과', '수학교육과', '물리교육과', '화학교육과', '생물교육과', '지구과학교육과', '가정교육과', '환경교육과', '기술교육과', '컴퓨터교육과', '음악교육과', '미술교육과', '체육교육과'
  ],
  '공주대학교': [
    '국어교육과', '한문교육과', '영어교육과', '윤리교육과', '교육학과', '경영·금융교육과', '문헌정보교육과', '특수교육과', '역사교육과', '일반사회교육과', '지리교육과', '유아교육과', '수학교육과', '물리교육과', '화학교육과', '생물교육과', '지구과학교육과', '환경교육과', '컴퓨터교육과', '기술·가정교육과', '체육교육과', '음악교육과', '미술교육과', '영어영문학과', '중어중문학과', '불어불문학과', '독어독문학과', '사학과', '지리학과', '경제통상학부', '경영학과', '관광경영학과', '관광중국어통역학전공', '법학과', '사회복지학과', '데이터정보물리학과', '응용통계학과', '화학과', '생명과학과', '지질환경과학과', '대기과학과', '토목재료소재공학과', '의류학전공', '생활환경지도학과', '간호학과', '보건행정학과', '응급구조학과', '의료정보학과', '게임디자인학과', '가구리빙디자인학과', '도자문화융합디자인학과', '뷰티코스메틱디자인학과', '만화애니메이션학부', '무용학과', '영화학과', '무대학과', '자율전공학과(공공인재)', '자율전공학과(인문사회과학대학)', '자율전공학과(자연과학대학)'
  ],
  '공주교육대학교': [
    '국어교육과', '윤리교육과', '사회과교육과', '수학교육과', '과학교육과', '실과교육과', '체육교육과', '음악교육과', '미술교육과', '영어교육과', '교육학과', '컴퓨터교육과'
  ],
  '충북대학교': [
    '국어국문학과', '중어중문학과', '영어영문학과', '독일언어문화학과', '프랑스언어문화학과', '러시아언어문화학과', '철학과', '사학과', '고고미술사학과', '인문학자율전공학부', '사회학과', '심리학과', '행정학과', '정치외교학과', '경제학과', '사회과학자율전공학부', '수학과', '정보통계학과', '물리학과', '화학과', '생물학과', '미생물학과', '생화학과', '천문우주학과', '지구환경과학과', '자연과학자율전공학부', '경영학부', '국제경영학과', '경영정보학과', '경영학자율전공학부', '토목공학부', '기계공학부', '화학공학과', '신소재공학과', '건축공학과', '안전공학과', '환경공학과', '공업화학과', '도시공학과', '건축학과', '공학자율전공학부', '전기공학부', '전자공학과', '반도체공학부', '정보통신공학부', '컴퓨터공학과', '소프트웨어학부', '지능로봇공학과', '전자정보자율전공학부', '식물자원학과', '축산학과', '산림학과', '지역건설공학과', '환경생명화학과', '특용식물학과', '원예과학과', '바이오시스템공학과', '식물의학과', '식품생명공학과', '목재·종지과학과', '농업경제학과', '농업생명환경자원공학부', '교육학과', '국어교육과', '영어교육과', '역사교육과', '지리교육과', '사회교육과', '윤리교육과', '물리교육과', '화학교육과', '생물교육과', '지구과학교육과', '수학교육과', '체육교육과', '식품영양학과', '아동복지학과', '의류학과', '주거환경학과', '소비자학과', '생활과학자율전공부', '수의예과', '약학과', '제약학과', '의예과', '간호학과', '인문사회자율전공계열', '자연과학자율전공계열', '조형예술학과(동양화)', '조형예술학과(서양화)', '조형예술학과(조소)', '디자인학과', '바이오헬스학부'
  ],
  '청주교육대학교': [
    '윤리교육과', '국어교육과', '사회과교육과', '수학교육과', '과학교육과', '체육교육과', '음악교육과', '미술교육과', '실과교육과', '교육학과', '영어교육과', '컴퓨터교육과'
  ],
};
