...
// 수식어 목록 (100개)
const adjectives = [
  '귀여운', '용감한', '지혜로운', '장난스러운', '우아한', '활발한', '느긋한', '재빠른', '온순한', '영리한',
  '신비로운', '행복한', '따뜻한', '차분한', '친절한', '부지런한', '당당한', '명랑한', '조용한', '씩씩한',
  '엉뚱한', '다정한', '깜찍한', '순수한', '사랑스러운', '재치있는', '멋진', '화려한', '단단한', '푸른',
  '작은', '큰', '긴', '짧은', '둥근', '네모난', '날렵한', '통통한', '날씬한', '힘센',
  '빠른', '느린', '높은', '낮은', '밝은', '어두운', '반짝이는', '매끄러운', '거친', '부드러운',
  '뾰족한', '무딘', '가벼운', '무거운', '젊은', '늙은', '새로운', '오래된', '달콤한', '쓴',
  '시원한', '따뜻한', '뜨거운', '차가운', '건조한', '축축한', '깨끗한', '지저분한', '향기로운', '고요한',
  '시끄러운', '조용한', '활기찬', '나른한', '졸린', '생기있는', '피곤한', '행복한', '슬픈', '화난',
  '놀란', '기쁜', '만족한', '불만족한', '궁금한', '호기심많은', '겁많은', '용감한', '소심한', '대담한',
  '예민한', '둔감한', '꼼꼼한', '대충하는', '진지한', '유머러스한', '엄격한', '관대한', '인내심있는', '급한'
];
