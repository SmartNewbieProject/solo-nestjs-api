    ...
    const categories = [
      {
        ...
        emojiUrl: 'https://sometimes-resources.s3.ap-northeast-2.amazonaws.com/resources/realtime.png',
        displayName: "실시간"
      },
      {
        code: ArticleRequestType.REVIEW,
        emojiUrl: 'https://sometimes-resources.s3.ap-northeast-2.amazonaws.com/resources/review.png',
        displayName: "리뷰"
      },
      {
        code: ArticleRequestType.LOVE_CONCERNS,
        emojiUrl: 'https://sometimes-resources.s3.ap-northeast-2.amazonaws.com/resources/love-letter.png',
        displayName: "연애상담"
      },
    ];
