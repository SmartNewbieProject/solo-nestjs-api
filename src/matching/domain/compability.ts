...
const DRINKING_COMPATIBILITY = {
  "자주 마셔도 괜찮음": [DrinkingOption.NEVER_PREFERRED, DrinkingOption.RARELY_PREFERRED],
  "가끔 마시는 정도면 좋음": [DrinkingOption.NEVER_PREFERRED, DrinkingOption.RARELY_PREFERRED],
  "거의 안 마셨으면 좋겠음": [DrinkingOption.OCCASIONALLY_OK, DrinkingOption.FREQUENTLY_OK],
  "전혀 안 마시는 사람이면 좋겠음": [DrinkingOption.OCCASIONALLY_OK, DrinkingOption.FREQUENTLY_OK, NEVERMIND],
  "상관없음": null,
};
...
const SMOKING_COMPATIBILITY = {
  "흡연자도 괜찮음": [SmokingOption.NON_SMOKER_PREFERRED, SmokingOption.STRICTLY_NON_SMOKER],
...
const TATTOO_COMPATIBILITY = {
  ...
  "문신이 없는 사람이었으면 좋겠음": [TattooOption.TATTOO_OK, TattooOption.SMALL_TATTOO_OK, NEVERMIND],
  "상관없음": null,
};
